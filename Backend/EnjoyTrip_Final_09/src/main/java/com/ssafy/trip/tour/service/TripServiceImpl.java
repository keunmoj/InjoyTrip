...
public class TripServiceImpl implements TripService {
	...
	@Override
	public TripResultDto tripListSidoGugun(TripParamDto tripParamDto) {
		TripResultDto tripResultDto = new TripResultDto();
		System.out.println("검색 수행");
		try {
	...
	// ========================== 콘텐츠 API ===========================
	@Override
	public TripResultDto contentList(TripParamDto tripParamDto) {
		TripResultDto tripResultDto = new TripResultDto();

		try {
			List<TripDto> list = dao.contentList(tripParamDto);
			int count = dao.contentListTotalCount(tripParamDto);
	...
	@Override
	public TripResultDto contentDetail(TripParamDto tripParamDto) {
		TripResultDto tripResultDto = new TripResultDto();
		...
		try {
			...
			TripDto dto = dao.contentDetail(tripParamDto);
			tripResultDto.setDto(dto);
			tripResultDto.setResult(SUCCESS);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@Override
	public TripResultDto contentListSido(TripParamDto tripParamDto) {
		TripResultDto tripResultDto = new TripResultDto();
		System.out.println("검색 수행");
		try {
			List<TripDto> list = dao.contentListSido(tripParamDto);
			int count = dao.contentListSidoTotalCount(tripParamDto);
	...
	@Override
	public TripResultDto contentListSidoGugun(TripParamDto tripParamDto) {
		TripResultDto tripResultDto = new TripResultDto();
		System.out.println("검색 수행");
		try {
			List<TripDto> list = dao.contentListSidoGugun(tripParamDto);
			int count = dao.contentListSidoGugunTotalCount(tripParamDto);
